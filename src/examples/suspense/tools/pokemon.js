...
const formatDate = (date) =>
    `${date.getHours()}:${String(date.getMinutes()).padStart(2, '0')} ${String(date.getSeconds()).padStart(
        2,
        '0'
...
function PokemonErrorBoundary(parentProps) {
    ...
    return (
        <ErrorBoundary fallbackRender={(props) => <ErrorFallback canReset={canReset} {...props} />} {...parentProps} />
    );
}
